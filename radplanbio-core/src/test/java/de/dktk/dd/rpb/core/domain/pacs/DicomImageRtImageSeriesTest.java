...
@PrepareForTest({DicomSeriesRtImage.class, Logger.class, LoggerFactory.class})
public class DicomImageRtImageSeriesTest {
    private Logger logger;
    private DicomSeriesRtImage rtImageSeries;
    ...
    public void setUp() throws Exception {
        ...
        rtImageSeries = new DicomSeriesRtImage();
    }

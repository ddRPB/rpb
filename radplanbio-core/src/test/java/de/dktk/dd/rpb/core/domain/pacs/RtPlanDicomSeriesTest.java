...
@PrepareForTest({RtPlanDicomSeries.class, Logger.class})
public class RtPlanDicomSeriesTest {
    private Logger logger;
    private RtPlanDicomSeries rtPlanSeries;
    ...
    public void setUp() throws Exception {
        ...
        rtPlanSeries = new RtPlanDicomSeries();
    }

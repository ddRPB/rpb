...
@PrepareForTest({DicomSeriesRtStruct.class, Logger.class, LoggerFactory.class})
public class DicomSeriesRtStructTest {
    private Logger logger;
    private DicomSeriesRtStruct rtStructSeries;
    ...
    public void setUp() throws Exception {
        ...
        rtStructSeries = new DicomSeriesRtStruct();
    }

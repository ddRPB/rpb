...
/**
 * <p>Java-Klasse für ValidatorType complex type.
 *
 ...
 *         &lt;element name="property" type="{http://labkey.org/data/xml}ValidatorPropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ValidatorType {
    ...
    protected List<ValidatorPropertyType> property;
    ...
    /**
     * Ruft den Wert der typeURI-Eigenschaft ab.
     *
     * @return possible object is
     * {@link String }
     */
    ...
    /**
     * Legt den Wert der typeURI-Eigenschaft fest.
     *
     * @param value allowed object is
     *              {@link String }
     */
     ...
     */
    public List<ValidatorPropertyType> getProperty() {
        if (property == null) {
            property = new ArrayList<ValidatorPropertyType>();
        }

...
/**
 * The Repository is a data-centric service for the {@link Subject} entity.
 * It provides the expected methods to get/delete a {@link Subject} instance
 * plus some methods to perform searches.
 * <p>
 * Search logic is driven by 2 kinds of parameters: a {@link Subject} instance used
...
public interface ISubjectRepository extends Repository<Subject, Integer> {

...
/**
 * JPA 2 Data Access Object for {@link DichotomousCriterion}.
...
@Named
@Singleton
public class DichotomousCriterionDao extends GenericDao<DichotomousCriterion, Integer> {

    //region Constructors

    public DichotomousCriterionDao() {

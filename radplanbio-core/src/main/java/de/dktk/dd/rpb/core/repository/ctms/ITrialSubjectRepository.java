...
/**
 * TrialSubjectRepository Interface
 *
 * The Repository is a data-centric service for the {@link TrialSubject} entity.
 * It provides the expected methods to get/delete a {@link TrialSubject} instance
 * plus some methods to perform searches.
 * <p>
 * Search logic is driven by 2 kinds of parameters: a {@link TrialSubject} instance used
 ...
 * @since 10 Apr 2013
 */
public interface ITrialSubjectRepository extends Repository<TrialSubject, Integer> {

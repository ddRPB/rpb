...
/**
 * StudyPersonRepository Interface
 *
 * The Repository is a data-centric service for the {@link StudyPerson} entity.
 * It provides the expected methods to get/delete a {@link StudyPerson} instance
 * plus some methods to perform searches.
 *
 * Search logic is driven by 2 kinds of parameters: a {@link StudyPerson} instance used
 ...
 * @since 16 July 2015
 */
public interface IStudyPersonRepository extends Repository<StudyPerson, Integer> {

 ...
 *
 * The Repository is a data-centric service for the {@link Organisation} entity.
 * It provides the expected methods to get/delete a {@link Organisation} instance
 * plus some methods to perform searches.
 *
 * Search logic is driven by 2 kinds of parameters: a {@link Organisation} instance used
 ...
 * @since 16 July 2015
 */
public interface IOrganisationRepository extends Repository<Organisation, Integer> {

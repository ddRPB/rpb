 ...
 *
 * The Repository is a data-centric service for the {@link Lab} entity.
 * It provides the expected methods to get/delete a {@link Lab} instance
 * plus some methods to perform searches.
 *
 * Search logic is driven by 2 kinds of parameters: a {@link Lab} instance used
 ...
 * @since 30 Aug 2017
 */
public interface ILabRepository extends Repository<Lab, Integer> {

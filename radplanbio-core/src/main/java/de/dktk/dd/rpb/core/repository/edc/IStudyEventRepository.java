...
/**
 * The Repository is a data-centric service for the {@link EventData} entity.
 * It provides the expected methods to get/delete a {@link EventData} instance
 * plus some methods to perform searches.
 * <p>
 * Search logic is driven by 2 kinds of parameters: a {@link EventData} instance used
 ...
 */
public interface IStudyEventRepository extends Repository<EventData, Integer> {

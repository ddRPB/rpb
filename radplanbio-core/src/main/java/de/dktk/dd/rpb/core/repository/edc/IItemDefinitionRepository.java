...
/**
 * The Repository is a data-centric service for the {@link ItemDefinition} entity.
 * It provides the expected methods to get/delete a {@link ItemDefinition} instance
 * plus some methods to perform searches.
 * <p>
 * Search logic is driven by 2 kinds of parameters: a {@link ItemDefinition} instance used
 ...
 * @since 12 Aug 2016
 */
public interface IItemDefinitionRepository extends Repository<ItemDefinition, Integer> {

...
/**
 * The Repository is a data-centric service for the {@link DicomStudy} entity.
 * It provides the expected methods to get/delete a {@link DicomStudy} instance
 * plus some methods to perform searches.
 * <p>
 * Search logic is driven by 2 kinds of parameters: a {@link DicomStudy} instance used
...
public interface IDicomStudyRepository extends Repository<DicomStudy, Integer> {

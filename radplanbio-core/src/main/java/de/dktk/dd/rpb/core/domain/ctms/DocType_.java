...
/**
 * DocType meta model which is used for JPA
...
public class DocType_ {
    ...
    // Raw attributes
    public static volatile SingularAttribute<DocType, Integer> id;
    public static volatile SingularAttribute<DocType, String> name;
    public static volatile SingularAttribute<DocType, String> description;

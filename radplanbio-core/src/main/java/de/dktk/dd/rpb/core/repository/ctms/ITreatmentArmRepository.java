...
/**
 * The Repository is a data-centric service for the {@link TreatmentArm} entity.
 * It provides the expected methods to get/delete a {@link TreatmentArm} instance
 * plus some methods to perform searches.
 * <p>
 * Search logic is driven by 2 kinds of parameters: a {@link TreatmentArm} instance used
 ...
 * @since 24 July 2015
 */
public interface ITreatmentArmRepository extends Repository<TreatmentArm, Integer> {

...
/**
 * StudyOrganisation Interface
 *
 * The Repository is a data-centric service for the {@link StudyOrganisation} entity.
 * It provides the expected methods to get/delete a {@link StudyOrganisation} instance
 * plus some methods to perform searches.
 *
 * Search logic is driven by 2 kinds of parameters: a {@link StudyOrganisation} instance used
 ...
 * @since 01 July 2015
 */
public interface IStudyOrganisationRepository extends Repository<StudyOrganisation, Integer> {

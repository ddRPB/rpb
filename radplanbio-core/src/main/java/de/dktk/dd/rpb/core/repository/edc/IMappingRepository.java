...
/**
 * The Repository is a data-centric service for the {@link Mapping} entity.
 * It provides the expected methods to get/delete a {@link Mapping} instance
 * plus some methods to perform searches.
 * <p>
 * Search logic is driven by 2 kinds of parameters: a {@link Mapping} instance used
 ...
 * @since 18 March 2015
 */
public interface IMappingRepository extends Repository<Mapping, Integer> {

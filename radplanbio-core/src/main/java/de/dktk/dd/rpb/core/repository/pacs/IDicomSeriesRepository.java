...
/**
 * The Repository is a data-centric service for the {@link DicomSeries} entity.
 * It provides the expected methods to get/delete a {@link DicomSeries} instance
 * plus some methods to perform searches.
 * <p>
 * Search logic is driven by 2 kinds of parameters: a {@link DicomSeries} instance used
...
public interface IDicomSeriesRepository extends Repository<DicomSeries, Integer> {
}

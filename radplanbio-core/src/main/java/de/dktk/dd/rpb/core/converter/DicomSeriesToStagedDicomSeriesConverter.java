...
public class DicomSeriesToStagedDicomSeriesConverter {
    ...
    public static List<StagedDicomSeries> getStagedDicomSeries(
            ...
            String uidPrefix,
            String partnerSideCode, String edcCode) {
        ...
        for (DicomSeries series : stageOneSeriesList) {
            ...
            movePropertiesFromDicomSeriesToStagedDicomSerie(series, stagedSeries);
    ...
    private static void setStageTwoInformation(List<DicomSeries> stageTwoSeriesList, StagedDicomSeries stagedSeries, String stageTwoUid) {
    ...
    private static void movePropertiesFromDicomSeriesToStagedDicomSerie(DicomSeries series, StagedDicomSeries stagedSeries) {
     ...
     * @return list of StagedDicomStudies
     */
    public static List<StagedDicomSeries> getStagedDicomSeries(List<DicomSeries> clinicalSeriesList, List<DicomSeries> stageOneSeriesList, String uidPrefix) {
        List<StagedDicomSeries> stagedDicomSeries = new ArrayList<>();
        for (DicomSeries clinicalSeries : clinicalSeriesList) {
            StagedDicomSeries stagedSeries = new StagedDicomSeries();
            movePropertiesFromDicomSeriesToStagedDicomSerie(clinicalSeries, stagedSeries);
    ...
    private static void setStageOneInformation(List<DicomSeries> stageOneSeriesList, StagedDicomSeries stagedSeries, String stageOneSeriesUid) {

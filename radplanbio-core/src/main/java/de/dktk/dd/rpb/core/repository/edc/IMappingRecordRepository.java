...
/**
 * MappingRecordRepository interface
 *
 * The Repository is a data-centric service for the {@link MappingRecord} entity.
 * It provides the expected methods to get/delete a {@link MappingRecord} instance
 * plus some methods to perform searches.
 * <p>
 * Search logic is driven by 2 kinds of parameters: a {@link MappingRecord} instance used
 ...
 * @since 18 March 2015
 */
public interface IMappingRecordRepository extends Repository<MappingRecord, Integer> {

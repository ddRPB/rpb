...
/**
 * The RtStructTypeRepository is a data-centric service for the {@link RtStructType} entity.
 * It provides the expected methods to get/delete a {@link RtStructType} instance
 * plus some methods to perform searches.
 * <p>
 * Search logic is driven by 2 kinds of parameters: a {@link RtStructType} instance used
 ...
 * @since 10 Apr 2013
 */
public interface RtStructTypeRepository extends Repository<RtStructType, Integer> {

...
/**
 * The Repository is a data-centric service for the {@link DicomSerie} entity.
 * It provides the expected methods to get/delete a {@link DicomSerie} instance
 * plus some methods to perform searches.
 * <p>
 * Search logic is driven by 2 kinds of parameters: a {@link DicomSerie} instance used
...
public interface IDicomSerieRepository extends Repository<DicomSerie, Integer> {
}

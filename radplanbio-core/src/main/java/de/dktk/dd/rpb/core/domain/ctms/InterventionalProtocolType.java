...
/**
 * InterventionalProtocolType domain object entity implementing AbstractProtocolType
 *
 * @author tomas@skripcak.net
 * @since 17 Sep 2013
 */
@Entity
@DiscriminatorValue("INTERVENTIONAL")
public class InterventionalProtocolType extends AbstractProtocolType {
    ...
    // Study Classification: Safety, Efficacy, Safety/Efficacy, Bio-equivalence, Bio-availability, Pharmacokinetics, Pharmacodynamics, Pharmacokinetics/Pharmacodynamics

    //region Finals

    private static final long serialVersionUID = 1L;
    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(InterventionalProtocolType.class);

    //endregion

    //region Constructors

    public InterventionalProtocolType() {
        // NOOP
    }
    ...
    public boolean equals(Object other) {
        return this == other || (other instanceof InterventionalProtocolType && hashCode() == other.hashCode());
    }

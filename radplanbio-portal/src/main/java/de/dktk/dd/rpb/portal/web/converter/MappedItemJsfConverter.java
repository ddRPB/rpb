...
import de.dktk.dd.rpb.core.repository.edc.IMappedItemRepository;
import de.dktk.dd.rpb.core.repository.edc.MappedItemRepository;
...
/**
 * JSF Converter for {@link de.dktk.dd.rpb.core.domain.edc.mapping.AbstractMappedItem}
 *
 * @author tomas@skripcak.net
 * @since 17 March 2015
 */
@Named("mappedItemConverter")
public class MappedItemJsfConverter implements Converter, Serializable {
    ...
    @Inject
    private IMappedItemRepository repository;

    public IMappedItemRepository getRepository() {

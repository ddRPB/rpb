...
/**
 * JSF Converter for {@link DocType}.
 */
@Named("docTypeConverter")
public class DocTypeJsfConverter implements Converter, Serializable {
    ...
    public IDocTypeRepository getDocTypeRepository() {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        return this.getDocTypeRepository().getById(toPk(value));
    }

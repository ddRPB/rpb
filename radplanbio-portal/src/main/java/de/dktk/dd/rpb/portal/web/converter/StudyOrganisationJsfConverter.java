...
/**
 * JSF Converter for {@link de.dktk.dd.rpb.core.domain.ctms.StudyOrganisation}
 *
 * @author tomas@skripcak.net
 * @since 01 July 2015
 */
@Named("studyOrganisationConverter")
public class StudyOrganisationJsfConverter implements Converter, Serializable {
    ...
    public StudyOrganisationJsfConverter() {

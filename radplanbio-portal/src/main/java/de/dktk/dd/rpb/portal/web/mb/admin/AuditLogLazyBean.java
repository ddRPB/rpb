...
/**
 * Lazy loading Bean for AuditLog presentation
 *
 * @author tomas@skripcak.net
 * @since 29 Jan 2015
 */
@Named("mbAuditLogLazy")
@Scope(value="view")
public class AuditLogLazyBean extends GenericLazyDataModel<AuditLog, Integer> {
    ...
    @Inject
    public AuditLogLazyBean(AuditLogRepository repository) {
        super(repository);
    }

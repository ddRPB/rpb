...
/**
 * JSF Converter for {@link AnnotationType}
 *
 * @author tomas@skripcak.net
 * @since 22 OCt 2013
 */
@Named("annotationTypeConverter")
public class AnnotationTypeJsfConverter implements Converter, Serializable {
    ...
    public AnnotationTypeRepository getAnnotationTypeRepository() {
        return this.annotationTypeRepository;
    }
    ...
    public AnnotationTypeJsfConverter() {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        ...
        return this.getAnnotationTypeRepository().getById(toPk(value));
    }
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        ...
        return ((Identifiable<Integer>) value).getId().toString();
    }

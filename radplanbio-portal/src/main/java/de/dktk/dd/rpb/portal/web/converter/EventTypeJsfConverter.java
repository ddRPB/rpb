...
/**
 * JSF Converter for {@link de.dktk.dd.rpb.core.domain.ctms.EventType}
 *
 * @author tomas@skripcak.net
 * @since 01 July 2015
 */
@Named("eventTypeConverter")
public class EventTypeJsfConverter implements Converter, Serializable {

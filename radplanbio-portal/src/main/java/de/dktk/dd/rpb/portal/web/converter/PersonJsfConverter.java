...
/**
 * JSF Converter for {@link de.dktk.dd.rpb.core.domain.ctms.Person}
 *
 * @author tomas@skripcak.net
 * @since 01 July 2015
 */
@Named("personConverter")
public class PersonJsfConverter implements Converter, Serializable {

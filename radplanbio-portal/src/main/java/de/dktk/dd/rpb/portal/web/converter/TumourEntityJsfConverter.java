...
/**
 * JSF Converter for {@link de.dktk.dd.rpb.core.domain.ctms.TumourEntity}
 *
 * @author tomas@skripcak.net
 * @since 01 July 2015
 */
@Named("tumourEntityConverter")
public class TumourEntityJsfConverter implements Converter, Serializable {
    ...
    public TumourEntityJsfConverter() {

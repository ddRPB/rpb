 ...
 */
@Component
@Path("/v1/webdav/studies/{studyIdentifier}/sites/{siteIdentifier}/subjects/{studySubjectIdentifier}/dcmstudies/{dicomStudyIdentifier}/dcmseries/{dicomSeriesIdentifier}/dcm")
public class WebDavEventAgnosticDicomFileService extends BaseService {

    //region Finals

    public final static Logger log = LoggerFactory.getLogger(WebDavEventAgnosticDicomFileService.class);
    ...
    public final javax.ws.rs.core.Response options() {
        ...
        return javax.ws.rs.core.Response.noContent()
                .header(DAV, "1, 2")
                .header("Allow", "GET,PROPFIND,OPTIONS")
                .build();
    }
    ...
    public  final javax.ws.rs.core.Response getFile(
        ...
        if (studyIdentifier != null && !studyIdentifier.isEmpty() &&
            ...
            log.error("WebDAV: Requested study/site/subject/dcmstudy/dcmseries/dcm identifier is null or empty.");

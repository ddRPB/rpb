 ...
 * @since 01 July 2015
 */
@Named("mbStudyPersonRole")
@Scope(value="view")
public class StudyPersonRoleBean extends CrudEntityViewModel<StudyPersonRole, Integer> {
     ...
     */
    @SuppressWarnings("unused")
    public void setRepository(IStudyPersonRoleRepository repository) {

...
/**
 * JSF Converter for {@link de.dktk.dd.rpb.core.domain.ctms.PersonStatus}
 *
 * @author tomas@skripcak.net
 * @since 01 July 2015
 */
@Named("personStatusConverter")
public class PersonStatusJsfConverter implements Converter, Serializable {
    ...
    public PersonStatusJsfConverter() {

...
/**
 * JSF Converter for {@link de.dkfz.portal.domain.edc.mapping.Mapping}
 *
 * @author tomas@skripcak.net
 * @since 19 March 2015
 */
@Named("mappingConverter")
public class MappingJsfConverter implements Converter, Serializable {

...
import de.dktk.dd.rpb.core.repository.admin.ctms.IStudyPersonRoleRepository;
...
/**
 * JSF Converter for {@link de.dktk.dd.rpb.core.domain.ctms.StudyPhase}
 *
 * @author tomas@skripcak.net
 * @since 01 July 2015
 */
@Named("studyPersonRoleConverter")
public class StudyPersonRoleJsfConverter implements Converter, Serializable {
    ...
    @Inject
    private IStudyPersonRoleRepository repository;

    public IStudyPersonRoleRepository getRepository() {
    ...
    public StudyPersonRoleJsfConverter() {

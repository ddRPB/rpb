...
public class MappingRecordBean extends CrudEntityViewModel<MappingRecord, Integer> {
     ...
     */
    @SuppressWarnings("unused")
    public void setRepository(IMappingRecordRepository repository) {
    ...
    */
    ...
    protected List<SortMeta> buildSortOrder() {
        ...
        UIComponent column = viewRoot.findComponent(":form:tabView:dtRecords:colSourceLabel");

        SortMeta sm1 = new SortMeta();
        sm1.setSortBy((UIColumn) column);
        sm1.setSortField("colSourceLabel");

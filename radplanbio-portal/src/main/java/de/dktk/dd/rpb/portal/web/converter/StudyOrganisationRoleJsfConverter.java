...
import de.dktk.dd.rpb.core.repository.ctms.IStudyOrganisationRoleRepository;
...
/**
 * JSF Converter for {@link de.dktk.dd.rpb.core.domain.ctms.StudyOrganisationRole}
 *
 * @author tomas@skripcak.net
 * @since 01 July 2015
 */
@Named("studyOrganisationRoleConverter")
public class StudyOrganisationRoleJsfConverter implements Converter, Serializable {
    ...
    @Inject
    private IStudyOrganisationRoleRepository repository;

    public IStudyOrganisationRoleRepository getRepository() {
    ...
    public StudyOrganisationRoleJsfConverter() {

...
/**
 * JSF Converter for {@link de.dkfz.portal.domain.ctms.SponsoringType}
 *
 * @author tomas@skripcak.net
 * @since 01 July 2015
 */
@Named("sponsoringTypeConverter")
public class SponsoringTypeJsfConverter implements Converter, Serializable {
    ...
    public SponsoringTypeJsfConverter() {

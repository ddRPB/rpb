...
/**
 * JSF Converter for {@link de.dktk.dd.rpb.core.domain.randomisation.TreatmentArm}
 *
 * @author tomas@skripcak.net
 * @since 24 July 2015
 */
@Named("treatmetnArmConverter")
public class TreatmentArmJsfConverter implements Converter, Serializable {
    ...
    public TreatmentArmJsfConverter() {

...
/**
 * Bean for administration of Portal entities
 *
...
@Named("mbPortal")
@Scope(value="view")
public class PortalBean extends CrudEntityViewModel<Portal, Integer> {

    //region Injects

    //region Repository

    private final IPortalRepository repository;

    /**
     * Get PortalRepository
     * @return PortalRepository
     */
    @SuppressWarnings("unused")
    @Override
    public IPortalRepository getRepository() {
    ...
    @Inject
    public PortalBean(IPortalRepository repository) {

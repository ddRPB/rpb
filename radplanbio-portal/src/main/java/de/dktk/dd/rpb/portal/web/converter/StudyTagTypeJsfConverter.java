...
/**
 * JSF Converter for {@link de.dktk.dd.rpb.core.domain.ctms.StudyTagType}
 *
 * @author tomas@skripcak.net
 * @since 01 July 2015
 */
@Named("studyTagTypeConverter")
public class StudyTagTypeJsfConverter implements Converter, Serializable {
    ...
    public StudyTagTypeJsfConverter() {

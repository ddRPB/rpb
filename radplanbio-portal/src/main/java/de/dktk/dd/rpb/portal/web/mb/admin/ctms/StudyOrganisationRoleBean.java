 ...
 * @since 01 July 2015
 */
@Named("mbStudyOrganisationRole")
@Scope(value="view")
public class StudyOrganisationRoleBean extends CrudEntityViewModel<StudyOrganisationRole, Integer> {
     ...
     */
    @SuppressWarnings("unused")
    public void setRepository(IStudyOrganisationRoleRepository repository) {

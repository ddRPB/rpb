...
import de.dktk.dd.rpb.core.repository.admin.ctms.IStudyStatusRepository;
...
/**
 * JSF Converter for {@link de.dktk.dd.rpb.core.domain.ctms.StudyStatus}
 *
 * @author tomas@skripcak.net
 * @since 01 July 2015
 */
@Named("studyStatusConverter")
public class StudyStatusJsfConverter implements Converter, Serializable {
    ...
    @Inject
    private IStudyStatusRepository repository;

    public IStudyStatusRepository getRepository() {
    ...
    public StudyStatusJsfConverter() {

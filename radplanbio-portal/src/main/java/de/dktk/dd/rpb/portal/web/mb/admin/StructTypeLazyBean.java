...
import de.dktk.dd.rpb.core.domain.admin.RtStructType_;
 ...
 * @since 01 Apr 2016
 */
@Named("mbStructTypeLazy")
@Scope(value="view")
public class StructTypeLazyBean extends GenericLazyDataModel<RtStructType, Integer> {

    //region Constructors

    @Inject
    public StructTypeLazyBean(RtStructTypeRepository repository) {
        super(repository);
    }
    ...
    @Override
    protected RtStructType getEntity(Map<String, Object> filters) {
        RtStructType example = this.repository.getNew();
    ...
    protected SearchParameters defaultOrder(SearchParameters searchParameters) {
        return searchParameters.orderBy(RtStructType_.name, OrderByDirection.ASC);
    }

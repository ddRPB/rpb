...
/**
 * JSF Converter for {@link RtStructType}.
 */
@Named("rtStructTypeConverter")
public class RtStructTypeJsfConverter implements Converter, Serializable {
    ...
    public RtStructTypeJsfConverter() {

jQuery(function() {
	...
	// .live is deprecated in a new jquery
    ...
    $(PrimeFaces.escapeClientId('form:askForDeleteDialogNo')).bind('keydown', function(e) {
    ...
    $(PrimeFaces.escapeClientId('form:askForDeleteDialogYes')).bind('keydown', function(e) {
		if ((e.shiftKey) && ((e.which && e.which == 9) || (e.keyCode && e.keyCode == 9))) {
			if (e.preventDefault) {
				e.preventDefault();
			}
    ...
    $(PrimeFaces.escapeClientId('form:askForSaveDialogNo')).bind('keydown', function(e) {
		if ((!e.shiftKey) && ((e.which && e.which == 9) || (e.keyCode && e.keyCode == 9))) {
			if (e.preventDefault) {
				e.preventDefault();
			}
    ...
    $(PrimeFaces.escapeClientId('form:askForSaveDialogYes')).bind('keydown', function(e) {
		if ((e.shiftKey) && ((e.which && e.which == 9) || (e.keyCode && e.keyCode == 9))) {
			if (e.preventDefault) {
				e.preventDefault();
			}
